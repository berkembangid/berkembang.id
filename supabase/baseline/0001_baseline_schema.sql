...
-- 96 migrasi (0001_identity_business_membership.sql sampai 0096_profil_tim_disunting_admin.sql).
--
...
--
-- Name: admin_save_team_profile(text, jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.admin_save_team_profile(p_slug text, p_data jsonb) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO ''
    AS $_$
declare
...
COMMENT ON TABLE public.team_profiles IS 'Profil tim publik yang disunting dari Ruang Mesin. Dibaca server saat halaman dibangun ulang, TIDAK pernah oleh peramban pengunjung. Baris yang tidak ada jatuh kembali ke content/team.ts.';
...
ALTER TABLE ONLY public.team_profiles
    ADD CONSTRAINT team_profiles_pkey PRIMARY KEY (slug);
...
--
-- Name: team_profiles team_profiles_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.team_profiles
    ADD CONSTRAINT team_profiles_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES auth.users(id) ON DELETE SET NULL;
...
--
-- Name: FUNCTION admin_save_team_profile(p_slug text, p_data jsonb); Type: ACL; Schema: public; Owner: -
--

REVOKE ALL ON FUNCTION public.admin_save_team_profile(p_slug text, p_data jsonb) FROM PUBLIC;
GRANT ALL ON FUNCTION public.admin_save_team_profile(p_slug text, p_data jsonb) TO authenticated;
...
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('306e622b-ea6c-4b3c-be4a-8a3a172cfb73', 'PERDAGANGAN_KULINER', 1, NULL, 'Laku / Jualan', 'Uang masuk dari barang atau makanan yang terjual', 'income', 'CASH_STAR', '4100', 'OPERASI', true, '{laku,jual,jualan,terjual,masuk,omzet,penjualan,laris}', 10, 'coa-emkm-v1', true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('9810d828-9d89-48c0-87d8-eca3044ce95b', 'PERDAGANGAN_KULINER', 2, NULL, 'Pemasukan lain', 'Uang masuk di luar jualan, misalnya sewa etalase atau komisi titip jual', 'income', 'CASH_STAR', '4200', 'OPERASI', true, '{"sewa etalase",komisi,"titip jual",bonus,hadiah,cashback}', 20, 'coa-emkm-v1', true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('5659988b-c432-48b9-8688-76bddd3a917b', 'PERDAGANGAN_KULINER', 3, NULL, 'Piutang dibayar', 'Pelanggan melunasi utangnya', 'income', 'CASH_STAR', '1300', 'OPERASI', false, '{"bayar utang",lunas,pelunasan,nyaur,dibayar}', 30, 'coa-emkm-v1', true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('e4276462-9d07-49aa-811c-75658ad9bea0', 'PERDAGANGAN_KULINER', 4, '4a', 'Modal masuk', 'Tambahan modal dari pemilik atau keluarga', 'income', 'CASH_STAR', '3100', 'PENDANAAN', false, '{modal,"tambah modal","suntik modal","setoran modal"}', 40, 'coa-emkm-v1', true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('8852991f-a36c-4d1d-8a9b-ee92c81c283d', 'PERDAGANGAN_KULINER', 4, '4b', 'Pinjaman masuk', 'Uang pinjaman yang cair', 'income', 'CASH_STAR', 'LIABILITY_STAR', 'PENDANAAN', false, '{pinjaman,pinjam,"kredit cair",cair,koperasi,"utang bank"}', 50, 'coa-emkm-v1', true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('2e9cf363-56bf-42be-86eb-b91fcf228a21', 'PERDAGANGAN_KULINER', 5, NULL, 'Belanja bahan / barang', 'Beli bahan baku atau stok dagangan', 'expense', '5100', 'CASH_OR_PAYABLE', 'OPERASI', true, '{belanja,kulak,"beli bahan",stok,"bahan baku",pasar,grosir}', 60, 'coa-emkm-v1', true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('a28b86b3-9f4b-46f1-8c4d-8d30afc88d70', 'PERDAGANGAN_KULINER', 6, '5210', 'Bahan bakar & energi', 'Gas, bensin, solar, minyak tanah', 'expense', '5210', 'CASH_OR_PAYABLE', 'OPERASI', true, '{gas,elpiji,bensin,solar,"minyak tanah",bbm}', 71, 'coa-emkm-v1', true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('e75faf43-4d20-4a44-8392-ea94f5ac52fc', 'PERDAGANGAN_KULINER', 6, '5220', 'Listrik, air, internet', 'Tagihan utilitas usaha', 'expense', '5220', 'CASH_OR_PAYABLE', 'OPERASI', true, '{listrik,token,air,pdam,internet,wifi,"pulsa data"}', 72, 'coa-emkm-v1', true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('1180b60a-14c6-4f71-8e00-d8a8929a3489', 'PERDAGANGAN_KULINER', 6, '5230', 'Gaji / upah', 'Upah karyawan atau pembantu', 'expense', '5230', 'CASH_OR_PAYABLE', 'OPERASI', true, '{gaji,upah,karyawan,pegawai,"bayar orang",borongan}', 73, 'coa-emkm-v1', true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('fc0da837-8f97-4e5c-bb00-e757df5a9b40', 'PERDAGANGAN_KULINER', 6, '5240', 'Sewa tempat', 'Sewa kios, lapak, atau dapur', 'expense', '5240', 'CASH_OR_PAYABLE', 'OPERASI', true, '{sewa,kontrakan,kios,lapak,ruko}', 74, 'coa-emkm-v1', true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('e7299ff1-c0b0-4792-b1f7-ff6228033b2e', 'PERDAGANGAN_KULINER', 6, '5250', 'Kemasan & label', 'Plastik, kardus, stiker, label produk', 'expense', '5250', 'CASH_OR_PAYABLE', 'OPERASI', true, '{kemasan,plastik,kardus,stiker,label,box,cup}', 75, 'coa-emkm-v1', true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('975dceb2-2a2d-474e-8c90-5b85265fb2ef', 'PERDAGANGAN_KULINER', 6, '5260', 'Transport & ongkir', 'Ongkos jalan, bensin kirim, ongkir ekspedisi', 'expense', '5260', 'CASH_OR_PAYABLE', 'OPERASI', true, '{ongkir,transport,kirim,ekspedisi,angkut,parkir,tol}', 76, 'coa-emkm-v1', true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('ed3e9a65-d71b-410c-b47b-08972879d138', 'PERDAGANGAN_KULINER', 6, '5270', 'Promosi & komisi aplikasi', 'Iklan, endorse, potongan aplikasi pesan antar', 'expense', '5270', 'CASH_OR_PAYABLE', 'OPERASI', true, '{promosi,iklan,endorse,"komisi aplikasi","potongan aplikasi",gofood,grabfood,shopeefood}', 77, 'coa-emkm-v1', true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('07848760-9c24-495d-aed7-b76998434eae', 'PERDAGANGAN_KULINER', 6, '5280', 'Penyusutan alat', 'Nilai alat usaha yang menyusut (dihitung sistem)', 'expense', '5280', 'CASH_OR_PAYABLE', 'OPERASI', true, '{penyusutan,susut}', 78, 'coa-emkm-v1', true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('3bc6a429-0cfa-47e5-a10f-71f19829f45d', 'PERDAGANGAN_KULINER', 6, '5290', 'Biaya usaha lainnya', 'Biaya usaha yang tidak masuk kelompok lain', 'expense', '5290', 'CASH_OR_PAYABLE', 'OPERASI', true, '{lain,"serba serbi","biaya lain",iuran,retribusi,sampah,keamanan}', 79, 'coa-emkm-v1', true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('4456a635-668c-4ccd-b144-90b2db1ff066', 'PERDAGANGAN_KULINER', 7, NULL, 'Bayar utang / cicilan', 'Membayar cicilan atau melunasi utang usaha', 'expense', 'LIABILITY_STAR', 'CASH_STAR', 'PENDANAAN', false, '{cicilan,nyicil,angsuran,"bayar utang","setor koperasi","bayar pinjaman"}', 80, 'coa-emkm-v1', true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('7e53e6ba-d58c-46d1-af07-879aba76f6e2', 'PERDAGANGAN_KULINER', 9, NULL, 'Ambil untuk rumah', 'Uang usaha yang dipakai untuk keperluan pribadi atau rumah', 'expense', '3200', 'CASH_STAR', 'PENDANAAN', false, '{rumah,anak,sekolah,spp,dapur,pribadi,"belanja rumah",arisan,kondangan}', 100, 'coa-emkm-v1', true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('6577626a-d932-4eeb-a291-25b0b9438b12', 'PERDAGANGAN_KULINER', 10, NULL, 'Ngutangin pelanggan', 'Barang sudah diberikan tapi pelanggan belum bayar', 'income', '1300', '4100', 'NON_KAS', true, '{ngutang,bon,kasbon,"belum bayar","utang pelanggan"}', 110, 'coa-emkm-v1', true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('4fa9fc2e-53f1-4da8-b6db-ed299f9bcc8f', 'JASA', 1, NULL, 'Pemasukan jasa', 'Uang masuk dari pekerjaan atau jasa yang selesai', 'income', 'CASH_STAR', '4100', 'OPERASI', true, '{masuk,bayaran,"ongkos jasa","upah kerja",servis,service,order,job,omzet}', 10, 'coa-emkm-v1', true, '2026-09-18 18:13:56.628718+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('e2bb2e12-c265-4569-9395-70510ccfdd0f', 'JASA', 2, NULL, 'Pemasukan lain', 'Uang masuk di luar pekerjaan utama, misalnya sewa alat atau komisi', 'income', 'CASH_STAR', '4200', 'OPERASI', true, '{"sewa alat",komisi,bonus,hadiah,cashback,royalti}', 20, 'coa-emkm-v1', true, '2026-09-18 18:13:56.628718+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('3733d255-64bd-4fec-9b83-238c018a8043', 'JASA', 3, NULL, 'Piutang dibayar', 'Pelanggan melunasi sisa pembayarannya', 'income', 'CASH_STAR', '1300', 'OPERASI', false, '{"bayar utang",lunas,pelunasan,nyaur,dibayar,"pelunasan termin"}', 30, 'coa-emkm-v1', true, '2026-09-18 18:13:56.628718+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('4332524a-4d02-44fc-9676-285bd27e45f3', 'JASA', 4, '4a', 'Modal masuk', 'Tambahan modal dari pemilik atau keluarga', 'income', 'CASH_STAR', '3100', 'PENDANAAN', false, '{modal,"tambah modal","suntik modal","setoran modal"}', 40, 'coa-emkm-v1', true, '2026-09-18 18:13:56.628718+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('460efd04-d173-4bb9-bff5-ea6867c0b7d2', 'JASA', 4, '4b', 'Pinjaman masuk', 'Uang pinjaman yang cair', 'income', 'CASH_STAR', 'LIABILITY_STAR', 'PENDANAAN', false, '{pinjaman,pinjam,"kredit cair",cair,koperasi,"utang bank"}', 50, 'coa-emkm-v1', true, '2026-09-18 18:13:56.628718+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('ee6304ab-9382-47e1-ba77-bf3c3fb466c1', 'JASA', 5, NULL, 'Bahan & alat habis pakai', 'Bahan yang habis terpakai untuk mengerjakan pesanan', 'expense', '5100', 'CASH_OR_PAYABLE', 'OPERASI', true, '{bahan,sparepart,onderdil,benang,kain,cat,oli,material,"habis pakai"}', 60, 'coa-emkm-v1', true, '2026-09-18 18:13:56.628718+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('49c3888a-a581-43ef-a05c-c397139107e7', 'JASA', 6, '5210', 'Bahan bakar & energi', 'Bensin, solar, atau gas untuk menjalankan usaha', 'expense', '5210', 'CASH_OR_PAYABLE', 'OPERASI', true, '{bensin,solar,gas,elpiji,bbm,"isi bensin"}', 71, 'coa-emkm-v1', true, '2026-09-18 18:13:56.628718+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('6f7991f7-a3aa-4cf3-85d4-877dbb3817a6', 'JASA', 6, '5220', 'Listrik, air, internet', 'Tagihan utilitas usaha', 'expense', '5220', 'CASH_OR_PAYABLE', 'OPERASI', true, '{listrik,token,air,pdam,internet,wifi,"pulsa data",server,hosting}', 72, 'coa-emkm-v1', true, '2026-09-18 18:13:56.628718+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('c75992ca-99d1-462f-a4ca-4836aa463340', 'JASA', 6, '5230', 'Gaji / upah', 'Upah pekerja, tukang, atau tenaga lepas', 'expense', '5230', 'CASH_OR_PAYABLE', 'OPERASI', true, '{gaji,upah,karyawan,tukang,freelance,"tenaga lepas",borongan}', 73, 'coa-emkm-v1', true, '2026-09-18 18:13:56.628718+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('f9bfb7e3-e1a7-4f68-bb3b-778733464fd2', 'JASA', 6, '5240', 'Sewa tempat', 'Sewa bengkel, studio, salon, atau ruang kerja', 'expense', '5240', 'CASH_OR_PAYABLE', 'OPERASI', true, '{sewa,kontrakan,bengkel,studio,ruko,coworking}', 74, 'coa-emkm-v1', true, '2026-09-18 18:13:56.628718+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('ee1b298b-107d-4ce8-aa62-5cc91c16728b', 'JASA', 6, '5250', 'Perlengkapan kerja', 'Sarung tangan, masker, alat tulis, dan perlengkapan habis pakai lain', 'expense', '5250', 'CASH_OR_PAYABLE', 'OPERASI', true, '{perlengkapan,"sarung tangan",masker,"alat tulis",atk,seragam}', 75, 'coa-emkm-v1', true, '2026-09-18 18:13:56.628718+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('41da7e69-43e2-45e0-ba39-c12fae129ccc', 'JASA', 6, '5260', 'Transport & perjalanan', 'Ongkos jalan ke tempat pelanggan, parkir, tol', 'expense', '5260', 'CASH_OR_PAYABLE', 'OPERASI', true, '{transport,"ongkos jalan",parkir,tol,ojek,grab,gojek,perjalanan}', 76, 'coa-emkm-v1', true, '2026-09-18 18:13:56.628718+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('660de80c-fa74-4a1a-be34-9f78b2b3282d', 'JASA', 6, '5270', 'Promosi & komisi aplikasi', 'Iklan, endorse, potongan aplikasi tempat Anda menerima order', 'expense', '5270', 'CASH_OR_PAYABLE', 'OPERASI', true, '{promosi,iklan,endorse,"komisi aplikasi","potongan aplikasi",ads}', 77, 'coa-emkm-v1', true, '2026-09-18 18:13:56.628718+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('3267dd60-1472-43db-b409-5039115c5cdc', 'JASA', 6, '5280', 'Penyusutan alat', 'Nilai alat usaha yang menyusut (dihitung sistem)', 'expense', '5280', 'CASH_OR_PAYABLE', 'OPERASI', true, '{penyusutan,susut}', 78, 'coa-emkm-v1', true, '2026-09-18 18:13:56.628718+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('4296009a-2951-45de-8fc2-483cf617eaca', 'JASA', 6, '5290', 'Biaya usaha lainnya', 'Biaya usaha yang tidak masuk kelompok lain', 'expense', '5290', 'CASH_OR_PAYABLE', 'OPERASI', true, '{lain,"serba serbi","biaya lain",iuran,retribusi,sampah,keamanan}', 79, 'coa-emkm-v1', true, '2026-09-18 18:13:56.628718+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('29de006b-f156-412b-9a05-5f17ae64ec32', 'JASA', 7, NULL, 'Bayar utang / cicilan', 'Membayar cicilan atau melunasi utang usaha', 'expense', 'LIABILITY_STAR', 'CASH_STAR', 'PENDANAAN', false, '{cicilan,nyicil,angsuran,"bayar utang","setor koperasi","bayar pinjaman"}', 80, 'coa-emkm-v1', true, '2026-09-18 18:13:56.628718+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('7b1df84b-efb7-4b4a-a604-496420a5fa71', 'JASA', 9, NULL, 'Ambil untuk rumah', 'Uang usaha yang dipakai untuk keperluan pribadi atau rumah', 'expense', '3200', 'CASH_STAR', 'PENDANAAN', false, '{rumah,anak,sekolah,spp,dapur,pribadi,"belanja rumah",arisan,kondangan}', 100, 'coa-emkm-v1', true, '2026-09-18 18:13:56.628718+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('67c51e43-28a6-46b1-b74d-ccf853876b72', 'JASA', 10, NULL, 'Pekerjaan belum dibayar', 'Pekerjaan sudah selesai tapi pelanggan belum membayar', 'income', '1300', '4100', 'NON_KAS', true, '{ngutang,bon,kasbon,"belum bayar","utang pelanggan",termin}', 110, 'coa-emkm-v1', true, '2026-09-18 18:13:56.628718+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('7127dc4b-9cf3-4ba5-9c28-cb7b5ad8ed53', 'JASA', 8, NULL, 'Beli alat / aset', 'Beli peralatan kerja yang dipakai lama', 'expense', '1600', 'CASH_OR_PAYABLE', 'INVESTASI', false, '{"beli alat",blender,bor,chiller,dispenser,etalase,freezer,gerinda,gerobak,kipas,kompresor,komputer,kulkas,kursi,laptop,lemari,meja,mesin,"mesin jahit",mixer,motor,oven,penggorengan,peralatan,perkakas,printer,rak,showcase,tenda,timbangan,vitrin,"wajan besar"}', 90, 'coa-emkm-v1', true, '2026-09-18 18:13:56.628718+07');
INSERT INTO public.category_templates (id, sector, category_code, subtype, label_umkm, description_umkm, direction, debit_rule, credit_rule, cash_flow_section, affects_pnl, trigger_keywords, sort_order, version, is_active, created_at) VALUES ('afc36674-38ea-450e-b61a-fb61fa06d409', 'PERDAGANGAN_KULINER', 8, NULL, 'Beli alat / aset', 'Beli peralatan usaha yang dipakai lama', 'expense', '1600', 'CASH_OR_PAYABLE', 'INVESTASI', false, '{alat,"beli kulkas",blender,bor,chiller,dispenser,etalase,freezer,gerinda,gerobak,kipas,kompor,kompresor,komputer,kulkas,kursi,laptop,lemari,meja,mesin,"mesin jahit",mixer,motor,oven,penggorengan,printer,rak,showcase,tenda,timbangan,vitrin,"wajan besar"}', 90, 'coa-emkm-v1', true, '2026-09-18 18:13:56.406632+07');
...
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('1100', 'Kas', 'ASET', 'DEBIT', false, 'BS_KAS', NULL, 10, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('1200', 'Bank / Giro', 'ASET', 'DEBIT', false, 'BS_GIRO', NULL, 20, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('1300', 'Piutang Usaha', 'ASET', 'DEBIT', false, 'BS_PIUTANG_USAHA', NULL, 30, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('1400', 'Persediaan', 'ASET', 'DEBIT', false, 'BS_PERSEDIAAN', NULL, 40, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('1500', 'Beban Dibayar di Muka', 'ASET', 'DEBIT', false, 'BS_BEBAN_DIBAYAR_DIMUKA', NULL, 50, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('1600', 'Aset Tetap', 'ASET', 'DEBIT', false, 'BS_ASET_TETAP', NULL, 60, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('1690', 'Akumulasi Penyusutan', 'ASET', 'KREDIT', true, 'BS_AKUMULASI_PENYUSUTAN', NULL, 70, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('2100', 'Utang Usaha', 'LIABILITAS', 'KREDIT', false, 'BS_UTANG_USAHA', NULL, 110, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('2200', 'Utang Bank', 'LIABILITAS', 'KREDIT', false, 'BS_UTANG_BANK', NULL, 120, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('2300', 'Utang Pinjaman Lain', 'LIABILITAS', 'KREDIT', false, 'BS_UTANG_BANK', NULL, 130, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('2400', 'Utang Pajak', 'LIABILITAS', 'KREDIT', false, 'BS_UTANG_PAJAK', NULL, 140, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('3100', 'Modal Pemilik', 'EKUITAS', 'KREDIT', false, 'BS_MODAL', NULL, 210, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('3200', 'Prive', 'EKUITAS', 'DEBIT', true, 'BS_MODAL', NULL, 220, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('3300', 'Saldo Laba', 'EKUITAS', 'KREDIT', false, 'BS_SALDO_LABA', NULL, 230, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('4100', 'Pendapatan Usaha', 'PENDAPATAN', 'KREDIT', false, 'IS_PENDAPATAN_USAHA', NULL, 310, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('4200', 'Pendapatan Lain-lain', 'PENDAPATAN', 'KREDIT', false, 'IS_PENDAPATAN_LAIN', NULL, 320, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('5100', 'Beban Pokok Penjualan', 'BEBAN', 'DEBIT', false, 'IS_BEBAN_USAHA', NULL, 410, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('5210', 'Beban Bahan Bakar & Energi', 'BEBAN', 'DEBIT', false, 'IS_BEBAN_USAHA', '5200', 421, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('5220', 'Beban Utilitas', 'BEBAN', 'DEBIT', false, 'IS_BEBAN_USAHA', '5200', 422, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('5230', 'Beban Gaji & Upah', 'BEBAN', 'DEBIT', false, 'IS_BEBAN_USAHA', '5200', 423, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('5240', 'Beban Sewa', 'BEBAN', 'DEBIT', false, 'IS_BEBAN_USAHA', '5200', 424, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('5250', 'Beban Kemasan & Label', 'BEBAN', 'DEBIT', false, 'IS_BEBAN_USAHA', '5200', 425, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('5260', 'Beban Transport & Ongkir', 'BEBAN', 'DEBIT', false, 'IS_BEBAN_USAHA', '5200', 426, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('5270', 'Beban Promosi & Komisi Platform', 'BEBAN', 'DEBIT', false, 'IS_BEBAN_USAHA', '5200', 427, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('5280', 'Beban Penyusutan', 'BEBAN', 'DEBIT', false, 'IS_BEBAN_USAHA', '5200', 428, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('5290', 'Beban Usaha Lain-lain', 'BEBAN', 'DEBIT', false, 'IS_BEBAN_USAHA', '5200', 429, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('5310', 'Beban Bunga Pinjaman', 'BEBAN', 'DEBIT', false, 'IS_BEBAN_LAIN', NULL, 510, true, '2026-09-18 18:13:56.406632+07');
INSERT INTO public.coa_accounts (code, name, account_type, normal_balance, is_contra, report_line, parent_code, sort_order, is_active, created_at) VALUES ('5400', 'Beban Pajak Penghasilan', 'BEBAN', 'DEBIT', false, 'IS_BEBAN_PAJAK', NULL, 520, true, '2026-09-18 18:13:56.406632+07');
...
INSERT INTO public.document_requirements (id, sector, doc_type, requirement, order_index, mission_key, note, created_at) VALUES ('d01a1f14-7ca1-4b8a-84bb-60e0c7443c9a', 'PERDAGANGAN_KULINER', 'ktp', 'wajib', 1, 'dokumen-ktp', 'Fondasi identitas pemilik usaha.', '2026-09-18 18:13:56.637971+07');
INSERT INTO public.document_requirements (id, sector, doc_type, requirement, order_index, mission_key, note, created_at) VALUES ('3ac41eea-c8e6-46b9-92f8-7e7df2080828', 'PERDAGANGAN_KULINER', 'nib', 'wajib', 2, 'dokumen-nib', 'Bisa diurus sendiri di OSS, gratis, sekitar 30 menit.', '2026-09-18 18:13:56.637971+07');
INSERT INTO public.document_requirements (id, sector, doc_type, requirement, order_index, mission_key, note, created_at) VALUES ('70324387-1f71-410d-8390-65c328182cfa', 'PERDAGANGAN_KULINER', 'pirt', 'wajib', 3, 'dokumen-pirt', 'Syarat edar pangan olahan rumah produksi.', '2026-09-18 18:13:56.637971+07');
INSERT INTO public.document_requirements (id, sector, doc_type, requirement, order_index, mission_key, note, created_at) VALUES ('d091638c-2c6d-4162-b041-5aa5f88704f3', 'PERDAGANGAN_KULINER', 'halal', 'wajib', 4, 'dokumen-halal', 'Wajib bagi usaha mikro dan kecil mulai 17 Oktober 2026 (PP 42/2024).', '2026-09-18 18:13:56.637971+07');
INSERT INTO public.document_requirements (id, sector, doc_type, requirement, order_index, mission_key, note, created_at) VALUES ('10122fcf-7ea5-41da-9e9b-c320c6ea9775', 'PERDAGANGAN_KULINER', 'npwp', 'disarankan', 5, 'dokumen-npwp', 'Diperlukan saat penjualan setahun mendekati Rp500 juta.', '2026-09-18 18:13:56.637971+07');
INSERT INTO public.document_requirements (id, sector, doc_type, requirement, order_index, mission_key, note, created_at) VALUES ('9f8ad286-cb3f-4ccc-bee0-16c75fcf3e6a', 'PERDAGANGAN_KULINER', 'izin_edar', 'disarankan', 6, 'dokumen-bpom', 'Saat produk masuk ritel modern.', '2026-09-18 18:13:56.637971+07');
INSERT INTO public.document_requirements (id, sector, doc_type, requirement, order_index, mission_key, note, created_at) VALUES ('2c8d9b6a-3a88-478a-8483-98e8da334e9c', 'PERDAGANGAN_KULINER', 'akta_pendirian', 'disarankan', 7, 'dokumen-merek', 'Perlindungan nama usaha untuk jangka panjang.', '2026-09-18 18:13:56.637971+07');
INSERT INTO public.document_requirements (id, sector, doc_type, requirement, order_index, mission_key, note, created_at) VALUES ('aeedb053-103d-4953-be87-02c0f04fd18f', 'JASA', 'ktp', 'wajib', 1, 'dokumen-ktp', 'Fondasi identitas pemilik usaha.', '2026-09-18 18:13:56.637971+07');
INSERT INTO public.document_requirements (id, sector, doc_type, requirement, order_index, mission_key, note, created_at) VALUES ('7fb32523-a079-41d0-b98e-880a1c37ed75', 'JASA', 'nib', 'wajib', 2, 'dokumen-nib', 'Bisa diurus sendiri di OSS, gratis, sekitar 30 menit.', '2026-09-18 18:13:56.637971+07');
INSERT INTO public.document_requirements (id, sector, doc_type, requirement, order_index, mission_key, note, created_at) VALUES ('f4932ba8-6174-4bc3-ba1a-59af4eba3355', 'JASA', 'npwp', 'disarankan', 3, 'dokumen-npwp', 'Diperlukan saat penjualan setahun mendekati Rp500 juta.', '2026-09-18 18:13:56.637971+07');
...
INSERT INTO public.feature_flags (flag_key, description, enabled, updated_by, updated_at) VALUES ('capture_voice', 'Catat dengan suara di layar Catat', true, NULL, '2026-09-18 18:13:56.919422+07');
INSERT INTO public.feature_flags (flag_key, description, enabled, updated_by, updated_at) VALUES ('capture_camera', 'Catat dengan foto nota (jalur OCR)', false, NULL, '2026-09-18 18:13:56.919422+07');
INSERT INTO public.feature_flags (flag_key, description, enabled, updated_by, updated_at) VALUES ('caption_live', 'Teks berjalan saat merekam suara', true, NULL, '2026-09-18 18:13:56.919422+07');
INSERT INTO public.feature_flags (flag_key, description, enabled, updated_by, updated_at) VALUES ('pdf_export', 'Unduh laporan sebagai PDF', true, NULL, '2026-09-18 18:13:56.919422+07');
INSERT INTO public.feature_flags (flag_key, description, enabled, updated_by, updated_at) VALUES ('discovery_institusi', 'Usaha bersedia ditemukan lembaga sebagai kandidat', true, NULL, '2026-09-18 18:13:56.919422+07');
...
INSERT INTO public.metric_definitions (metric_key, title, formula_text, source_note, unit, measurable, updated_at) VALUES ('dau', 'Akun aktif harian', 'Jumlah usaha dengan minimal satu transaksi terkonfirmasi atau satu tutup kas pada tanggal itu.', 'transactions + daily_closings; akun demo dikecualikan.', 'count', true, '2026-09-18 18:13:56.919422+07');
INSERT INTO public.metric_definitions (metric_key, title, formula_text, source_note, unit, measurable, updated_at) VALUES ('new_accounts', 'Akun baru', 'Jumlah usaha yang dibuat pada tanggal itu.', 'businesses.created_at.', 'count', true, '2026-09-18 18:13:56.919422+07');
INSERT INTO public.metric_definitions (metric_key, title, formula_text, source_note, unit, measurable, updated_at) VALUES ('transactions_recorded', 'Transaksi tercatat', 'Jumlah transaksi berstatus terkonfirmasi pada tanggal itu.', 'transactions; yang dibatalkan tidak dihitung.', 'count', true, '2026-09-18 18:13:56.919422+07');
INSERT INTO public.metric_definitions (metric_key, title, formula_text, source_note, unit, measurable, updated_at) VALUES ('capture_path_mix', 'Bauran jalur catat', 'Bagian tiap jalur (TEXT_ONLY / WHISPER / OCR) terhadap seluruh capture pada rentang itu.', 'transaction_captures.capture_path.', 'ratio', true, '2026-09-18 18:13:56.919422+07');
INSERT INTO public.metric_definitions (metric_key, title, formula_text, source_note, unit, measurable, updated_at) VALUES ('capture_latency_p95', 'Ucapan sampai draf (p95)', 'Persentil ke-95 selisih waktu antara capture dibuat dan drafnya selesai.', 'transaction_captures.created_at sampai completed_at.', 'ms', true, '2026-09-18 18:13:56.919422+07');
INSERT INTO public.metric_definitions (metric_key, title, formula_text, source_note, unit, measurable, updated_at) VALUES ('provider_errors_24h', 'Kegagalan penyedia AI 24 jam', 'Jumlah percobaan yang berakhir gagal dalam 24 jam terakhir.', 'ai_runs.status = failed.', 'count', true, '2026-09-18 18:13:56.919422+07');
INSERT INTO public.metric_definitions (metric_key, title, formula_text, source_note, unit, measurable, updated_at) VALUES ('queue_age_p95', 'Umur antrean (p95)', 'Persentil ke-95 lama pekerjaan menunggu sebelum dikerjakan.', 'ai_jobs.created_at sampai locked_at.', 'ms', true, '2026-09-18 18:13:56.919422+07');
...
INSERT INTO public.missions (id, code, title, description, category, status, requirements, reward, created_at, updated_at) VALUES ('3eb9ebb5-549d-4d95-9efc-c6390ac97211', 'record_transactions', 'Catat transaksi usaha', 'Mulai dengan mencatat pemasukan atau pengeluaran yang benar-benar terjadi.', 'pencatatan', 'active', '{"effort": "low", "evidence": "confirmed_transactions"}', '{"impact": 45}', '2026-09-18 18:13:56.351733+07', '2026-09-18 18:13:56.351733+07');
INSERT INTO public.missions (id, code, title, description, category, status, requirements, reward, created_at, updated_at) VALUES ('e91c8293-a1ef-4154-82da-22ea1be05745', 'upload_nib', 'Lengkapi NIB usaha', 'Unggah NIB agar legalitas dasar usaha dapat dibaca dan Anda periksa.', 'legalitas', 'active', '{"effort": "medium", "evidence": "nib_document"}', '{"impact": 25}', '2026-09-18 18:13:56.351733+07', '2026-09-18 18:13:56.351733+07');
INSERT INTO public.missions (id, code, title, description, category, status, requirements, reward, created_at, updated_at) VALUES ('66ada702-631a-43a2-8a3f-08c8471d5e11', 'complete_profile', 'Lengkapi profil usaha', 'Isi nama usaha, sektor, lokasi, dan kontak agar data usaha mudah dipahami.', 'profil', 'active', '{"effort": "low", "evidence": "profile_fields"}', '{"impact": 6}', '2026-09-18 18:13:56.351733+07', '2026-09-18 18:13:56.351733+07');
INSERT INTO public.missions (id, code, title, description, category, status, requirements, reward, created_at, updated_at) VALUES ('ff7cd933-8646-41f6-9a86-ce012abda34b', 'use_digital_payment', 'Catat pembayaran digital', 'Saat menerima QRIS, transfer, atau dompet digital, pilih cara pembayaran yang sesuai.', 'pencatatan', 'active', '{"effort": "low", "evidence": "digital_payment_transaction"}', '{"impact": 6}', '2026-09-18 18:13:56.351733+07', '2026-09-18 18:13:56.351733+07');
INSERT INTO public.missions (id, code, title, description, category, status, requirements, reward, created_at, updated_at) VALUES ('486b3eb9-103e-41ac-bce9-df246c258cbf', 'record_utilities', 'Catat biaya rutin usaha', 'Catat listrik, air, atau internet usaha agar biaya operasional lebih lengkap.', 'pencatatan', 'active', '{"effort": "low", "evidence": "utilities_transaction"}', '{"impact": 6}', '2026-09-18 18:13:56.351733+07', '2026-09-18 18:13:56.351733+07');
INSERT INTO public.missions (id, code, title, description, category, status, requirements, reward, created_at, updated_at) VALUES ('e96e9fc5-4e03-46a0-887e-09e1207f95f3', 'record_sales_channel', 'Catat asal pesanan', 'Isi asal pesanan ketika transaksi datang dari toko, pesan antar, atau kanal lain.', 'pencatatan', 'active', '{"effort": "low", "evidence": "sales_channel_transaction"}', '{"impact": 6}', '2026-09-18 18:13:56.351733+07', '2026-09-18 18:13:56.351733+07');
INSERT INTO public.missions (id, code, title, description, category, status, requirements, reward, created_at, updated_at) VALUES ('194528fe-71bc-4684-bc3e-0a9785373076', 'upload_certificate', 'Tambahkan sertifikat pendukung', 'Unggah sertifikat atau izin tambahan yang memang dimiliki usaha.', 'dokumen', 'active', '{"effort": "medium", "evidence": "supporting_certificate"}', '{"impact": 6}', '2026-09-18 18:13:56.351733+07', '2026-09-18 18:13:56.351733+07');
...
INSERT INTO public.readiness_rule_sets (id, version, status, rules, weights, thresholds, created_by, published_by, published_at, created_at, updated_at, effective_at) VALUES ('06ebb8b5-0af4-4d2a-a8ce-9650cb2ee17b', 'wp03-baseline-v1', 'retired', '{"source": "wp03_backfill", "authority": "transitional"}', '{}', '{}', NULL, NULL, '2026-09-18 18:13:56.141152+07', '2026-09-18 18:13:56.141152+07', '2026-09-18 18:13:56.351733+07', NULL);
INSERT INTO public.readiness_rule_sets (id, version, status, rules, weights, thresholds, created_by, published_by, published_at, created_at, updated_at, effective_at) VALUES ('c2f8e96d-a193-4d86-9137-35889891df72', 'wp08-pilot-v1', 'published', '{"disclaimer": "Konfigurasi kesiapan data BERKEMBANG.ID, bukan penilaian resmi regulator atau jaminan pembiayaan."}', '{"utilities": 6, "basic_legality": 25, "complete_profile": 6, "digital_payments": 6, "digital_footprint": 6, "certificates_training": 6, "transaction_recording": 45}', '{"strong": 80, "building": 0, "consistent": 65, "developing": 35}', NULL, NULL, '2026-09-18 18:13:56.351733+07', '2026-09-18 18:13:56.351733+07', '2026-09-18 18:13:56.351733+07', '2026-09-18 18:13:56.351733+07');
INSERT INTO public.readiness_rule_sets (id, version, status, rules, weights, thresholds, created_by, published_by, published_at, created_at, updated_at, effective_at) VALUES ('a31d1c52-4f6c-4a66-b289-1f8e447f00a5', 'wp08-pilot-v2', 'published', '{"bronze": {"A1": 8, "A3": 14, "B1": 0.70, "D1": 1}, "levels": ["MULAI", "TEMBAGA", "PERAK", "EMAS"], "windows": {"habitDays": 30, "qualityDays": 90, "evidenceDays": 90, "fullMonthMinDays": 8, "fullMonthLookback": 3}, "graceDays": 7, "components": {"A1": {"gold": 24, "pillar": "A", "silver": 20, "partial": 8}, "A2": {"gold": 20, "pillar": "A", "silver": 12, "partial": 4}, "A3": {"gold": 90, "pillar": "A", "silver": 60, "partial": 14}, "B1": {"gold": 0.95, "pillar": "B", "silver": 0.90, "partial": 0.70}, "B2": {"gold": 3, "pillar": "B", "silver": 2, "partial": 1}, "B3": {"gold": 0.70, "pillar": "B", "silver": 0.40, "partial": 0.20}, "B4": {"gold": 2, "pillar": "B", "silver": null, "partial": 1}, "C1": {"gold": 4, "pillar": "C", "silver": 3, "partial": 1}, "C2": {"gold": 4, "pillar": "C", "silver": 4, "partial": 1}, "D1": {"gold": 1, "pillar": "D", "silver": 1, "partial": null}, "D2": {"gold": 6, "pillar": "D", "silver": 3, "partial": 1}, "D3": {"gold": 1, "pillar": "D", "silver": null, "partial": null}}, "disclaimer": "Tingkat kesiapan menggambarkan kelengkapan dan kebiasaan pencatatan usaha Anda, dihitung otomatis dengan aturan terbuka. Ini bukan penilaian resmi, bukan skor kredit, dan bukan jaminan pembiayaan.", "bigSpendIdr": 500000, "effortOrder": ["C2", "D1", "C1_NIB", "A2", "A1", "B3", "C1_HALAL", "D2"]}', '{}', '{}', NULL, NULL, '2026-09-18 18:13:56.722065+07', '2026-09-18 18:13:56.722065+07', '2026-09-18 18:13:56.722065+07', '2026-09-18 18:13:56.722065+07');
