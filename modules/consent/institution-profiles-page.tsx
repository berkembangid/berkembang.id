...
export default function InstitutionProfilesPage() {
  ...
  return <DashboardPage>
    <PageHeader title="Profil usaha berizin" description="Lihat hanya bagian yang diizinkan pemilik. Setiap pembukaan dan penyimpanan ringkasan dicatat." icon={FileCheck2} />
