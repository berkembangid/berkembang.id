...
export const BROADCAST_MESSAGES: Record<string, string> = {
  ...
  KUOTA_BROADCAST_BULAN_INI_HABIS:
    "Kuota siaran bulan ini sudah terpakai. Kuotanya kembali pada awal bulan berikutnya.",
  ...
  BUKAN_ADMIN: "Hanya pengelola Berkembang.id yang bisa meninjau siaran.",
  BUTUH_PERAN_OPS: "Akun Anda belum punya peran untuk meninjau siaran.",
  ALASAN_WAJIB: "Tulis alasan singkat lebih dulu. Setiap keputusan harus bisa dijelaskan nanti.",
  BROADCAST_TIDAK_DITEMUKAN: "Siaran itu sudah tidak ada.",
  BROADCAST_SUDAH_DITINJAU: "Siaran itu sudah ditinjau orang lain. Muat ulang daftarnya.",
  BROADCAST_BUKAN_MILIK_LEMBAGA_INI: "Siaran itu bukan milik lembaga Anda.",
