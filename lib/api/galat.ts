...
export const PESAN_GALAT: Record<string, string> = {
  ...
  SHORTLIST_UNAVAILABLE: "Daftar tersimpan belum bisa dimuat. Coba lagi sebentar lagi.",
  ...
  QUOTA_UNAVAILABLE: "Sisa kuota belum bisa dibaca. Coba lagi sebentar lagi.",
  NOTE_TOO_LONG: "Catatan paling panjang 500 huruf. Ringkas sedikit, lalu simpan lagi.",
  NOT_SHORTLISTED: "Kandidat ini sudah tidak ada di daftar tersimpan Anda. Simpan lagi dulu, baru beri catatan.",
  ...
  SHORTLIST_UPDATE_FAILED: "Daftar tersimpan belum diperbarui. Coba lagi sebentar lagi.",
