...
import playbook from "@/config/migrations-playbook.json";
 ...
 *
 * Tetap ditulis tangan di sana, bukan dibaca dari folder: daftar yang
 * dihasilkan dari isi folder membuat pemeriksaan ini hampa, karena apa pun
 * yang ada di folder otomatis dianggap benar. Yang dijaga justru sebaliknya --
 * bahwa tidak ada migrasi yang masuk, hilang, atau berubah nama tanpa ada
 * manusia yang menuliskannya.
 *
 * Yang berubah hanyalah jumlah tempatnya: dari dua salinan menjadi satu.
 */
const expectedMigrations: string[] = playbook.migrations;
